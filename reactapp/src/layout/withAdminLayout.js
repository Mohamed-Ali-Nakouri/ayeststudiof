              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2022 © Steamseo</span>
                      </Col>
                      <Col md={12} xs={24}>
                        <div className="admin-footer__links" >
                        <NavLink style={{paddingLeft: 13, textDecoration: 'none',display:'inline'}} to="#">About </NavLink>
                        <NavLink style={{paddingLeft: 13, textDecoration: 'none',display:'inline'}} to="#">Team </NavLink>
                        <NavLink style={{paddingLeft: 13, textDecoration: 'none',display:'inline'}} to="#">Contact </NavLink>
                        </div>
                      </Col>
                    </Row>
                  </Footer>
